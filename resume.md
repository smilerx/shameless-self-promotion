#Michael Dunn
	...
	my_cool_titles = ['Software Engineer', 'Founder', 'Blogger'].append('Some Other Buzzword You're Looking For!')
...
**Summary**  
The ASSA Web Application was a joint project between Notre Dame and a 3rd party .Net developer to convert/replace an complex, but outdated Access database.
I
...
**Project Results**  
Since go-live, the system has processed over 10 million dollars in electronic refunds. Additionally, we have reduced costs and solved a significant PR issue.
